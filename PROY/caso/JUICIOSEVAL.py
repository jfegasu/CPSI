...
def open_file_dialog():
    ...
    XEVALUARAPRENDIZ=rutinas.Extrae(data1,"select DNI,NOMBRE,APELLIDOS,COUNT(*) POREVALUAR FROM data1 WHERE JUICIO IN('POR EVALUAR')  AND ESTADO IN ('EN FORMACION') GROUP BY DNI,NOMBRE,APELLIDOS ORDER BY 1,2")
